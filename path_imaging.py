...
def show_path_page():
    ...
    st.write("This feature allows you to upload an image of blood cells and use an object detection model to detect the white blood cells, red blood cells, and platelets.")
    ...
    st.write("## Add in sliders")
    confidence_threshold = st.slider('Confidence threshold: What is the minimum acceptable confidence level for displaying a bounding box?', 0.0, 1.0, 0.5, 0.01)
    overlap_threshold = st.slider('Overlap threshold: What is the maximum amount of overlap permitted between visible bounding boxes?', 0.0, 1.0, 0.5, 0.01)
